...
def _build_timeline(user: str, doc_s: dict, del_s: dict,
    ...
    # [FIX-1] Include user-attributed apps first, then shared pool
    ...
    # Still include shared pool apps for timeline detection
...
def _assign_risk_labels(ranked_users: list[dict]) -> None:
    ...
    # Guarantees p80 is reachable and the highest scorer always qualifies for HIGH.
...
def main() -> None:
    ...
    print()
    print("  ╔══════════════════════════════════════════════════════╗")
    print("  ║       Forensic Artifact Correlator - v6             ║")
    print("  ║       log1p · norm-fix · evt-fix · label-fix       ║")
    print("  ╚══════════════════════════════════════════════════════╝")
    print(f"\n  JSON dir : {json_dir}\n  Output   : {out_path}\n")
